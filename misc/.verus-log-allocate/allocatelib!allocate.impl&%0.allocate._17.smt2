...
;; src/allocate.rs:2605:41: 2605:47 (#0)
...
(declare-const new_size$1@ (_ BitVec 64))
(assert
 true
)
...
(assert
 (not (=>
   %%location_label%%0
   (bvule ((_ zero_extend 1) (bvor new_size$1@ ((_ zero_extend 63) (_ bv1 1)))) (bvadd
     ((_ zero_extend 1) new_size$1@) ((_ zero_extend 64) (_ bv1 1))
)))))
(get-info :all-statistics)
(get-info :version)
