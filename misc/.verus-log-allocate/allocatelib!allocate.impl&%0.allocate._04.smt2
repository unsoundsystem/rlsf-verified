...
;; src/allocate.rs:502:25: 502:31 (#0)
...
(declare-const overhead@ (_ BitVec 64))
(assert
 (= (let
   ((tmp$$$$bitvectmp0 (_ bv32 6)))
   (ite
    (= tmp$$$$bitvectmp0 (_ bv0 6))
    tmp$$$$bitvectmp1
    (bvurem p@ ((_ zero_extend 58) tmp$$$$bitvectmp0))
   )
...
(assert
 (= (let
   ...
   (ite
    (= tmp$$$$bitvectmp0 (_ bv0 6))
    tmp$$$$bitvectmp1
    (bvurem b@ ((_ zero_extend 58) tmp$$$$bitvectmp0))
   )
  ) ((_ zero_extend 63) (_ bv0 1))
))
(assert
 (= ((_ zero_extend 1) overhead@) (bvsub ((_ zero_extend 1) p@) ((_ zero_extend 1) b@)))
)
 ...
 (not (=>
   ...
   (= (let
     ...
     (ite
      (= tmp$$$$bitvectmp0 (_ bv0 6))
      tmp$$$$bitvectmp1
      (bvurem overhead@ ((_ zero_extend 58) tmp$$$$bitvectmp0))
     )
    ) ((_ zero_extend 63) (_ bv0 1))
))))
(get-info :all-statistics)
