...
;; src/allocate.rs:2570:37: 2570:43 (#0)
...
(assert
 (= (let
   ...
   (ite
    ...
    tmp$$$$bitvectmp1
    (bvurem new_size$1@ ((_ zero_extend 61) tmp$$$$bitvectmp0))
   )
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand (bvor new_size$1@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 62) (_ bv2
       2
     ))
    ) ((_ zero_extend 63) (_ bv0 1))
))))
