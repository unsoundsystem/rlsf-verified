...
;; src/allocate.rs:1356:41: 1356:47 (#0)
...
(declare-const new_free_block_size@ (_ BitVec 64))
...
(assert
 (= (let
   ...
   (ite
    ...
    tmp$$$$bitvectmp1
    (bvurem new_free_block_size@ ((_ zero_extend 61) tmp$$$$bitvectmp0))
   )
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand new_free_block_size@ ((_ zero_extend 62) (_ bv2 2))) ((_ zero_extend 63)
     (_ bv0 1)
)))))
(get-info :all-statistics)
(get-info :version)
