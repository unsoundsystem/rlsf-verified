...
;; src/allocate.rs:896:29: 896:35 (#0)
...
(assert
 (= (let
   ...
   (ite
    ...
    tmp$$$$bitvectmp1
    (bvurem new_free_block_size@ ((_ zero_extend 62) tmp$$$$bitvectmp0))
   )
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand new_free_block_size@ ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63)
     (_ bv0 1)
)))))
(get-info :all-statistics)
(get-info :version)
