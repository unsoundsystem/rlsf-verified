...
;; src/allocate.rs:243:21: 243:27 (#0)
...
(declare-const block_size@ (_ BitVec 64))
(assert
 (bvuge block_size@ ((_ zero_extend 58) (_ bv32 6)))
)
...
(assert
 (not (=>
   %%location_label%%0
   (bvuge (bvand block_size@ (_ bv18446744073709551584 64)) ((_ zero_extend 58) (_ bv32
      6
))))))
(get-info :all-statistics)
(get-info :version)
